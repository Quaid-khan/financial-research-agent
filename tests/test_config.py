...
def test_valid_configuration():
    ...
    with patch.dict(os.environ, env_vars, clear=True):
        ...
        assert settings.gemini_api_key == "AIzaSyTestKey1234567890abcdef"
...
def test_placeholder_gemini_api_key():
    """Test that placeholder GEMINI_API_KEY raises ConfigurationError."""
    env_vars = {
        "GEMINI_API_KEY": "your_gemini_api_key_here",
        "SEC_EDGAR_USER_AGENT": "FinancialResearchAgent analyst@domain.com",
    }
    with patch.dict(os.environ, env_vars, clear=True):
        with pytest.raises(ConfigurationError, match="GEMINI_API_KEY is missing or unconfigured"):
            get_settings()
